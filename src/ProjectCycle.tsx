    ...
    <div style={{width: "calc(100% - 40px)", height: "calc(100vh - 140px)"}}>
      ...
      <g id="Group 78">
        <g id="BGLines">
          ...
          <path id="Rectangle 2" d="M1086 136H3079C3095.57 136 3109 149.431 3109 166V1951C3109 1967.57 3095.57 1981 3079 1981H1116C1099.43 1981 1086 1967.57 1086 1951V1814.43" stroke="#56ACC3" stroke-width="12" />
          <path id="Line 1" d="M1086 1825L1086 140" stroke="#56ACC3" stroke-width="6" stroke-dasharray="36 36" />
        </g>
        <g id="Formulate" opacity={selectedHeader === 'Formulate' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head" style={{cursor:"pointer"}} onClick={() => {selectedHeader !== 'Formulate' ? setSelectedHeader('Formulate') : setSelectedHeader(null)}}>
            <circle id="Ellipse 1" cx="97" cy="136" r="31" fill="white" stroke="#E4882E" stroke-width="8" />
            <text id="1" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="90.4219" y="145.28">1</tspan>
            </text>
            <text id="Formulate_2" fill="#E4882E" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
          ...
          <g className="PipelineModule Atlas" opacity={atlas && online ? 1 : 0.25}>
            ...
            <g>
              <text fill="#014B7A" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="18" font-style="italic" letter-spacing="0em">
                <tspan x="151" y="260.22">Atlas ERP</tspan>
              </text>
              <text fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="18" letter-spacing="0em">
          ...
          <g className="PSDDD Offline" opacity={1}>
            ...
            <g>
              ...
              <text fill="#D52B1E" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="18" font-style="italic" letter-spacing="0em">
          ...
          <g className="PIP SharePoint" opacity={sharePoint && online ? 1 : 0.25}>
            ...
            <g>
              ...
              <text fill="#028085" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="18" font-style="italic" letter-spacing="0em">
          ...
          <g className="PPG SharePoint" opacity={sharePoint && online ? 1 : 0.25}>
          ...
          <g className="ProjectDoc SharePoint Website" opacity={(sharePoint || website) && online ? 1 : 0.25}>
            ...
            <g>
              ...
              <text fill="#BCBEC0" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="18" font-style="italic" letter-spacing="0em">
          ...
          <g className="JPPD SharePoint Website" opacity={(sharePoint || website) && online ? 1 : 0.25}>
          ...
          <g className="WorkshopReport Offline" opacity={1}>
          ...
          <g className="SurveyData Offline" opacity={1}>
          ...
          <g className="GD Offline" opacity={1}>
          ...
          <g className="StakeholderMeetingReport Offline" opacity={1}>
          ...
          <g className="BOTR Offline" opacity={1}>
          ...
          <g className="FR Offline" opacity={1}>
          ...
          <g className="GA Offline" opacity={1}>
          ...
          <g className="ProjectQA SharePoint" opacity={sharePoint && online ? 1 : 0.25}>
          ...
          <g className="SESP Offline" opacity={1}>
          ...
          <g className="RiskRegister Atlas" opacity={atlas && online ? 1 : 0.25}>
        ...
        <g id="SelectImplementingPartner" opacity={selectedHeader === 'SelectImplementingPartner' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head_2"style={{cursor:"pointer"}} onClick={() => {selectedHeader !== 'SelectImplementingPartner' ? setSelectedHeader('SelectImplementingPartner') : setSelectedHeader(null)}}>
            <circle id="Ellipse 2" cx="421" cy="136" r="31" fill="white" stroke="#E4882E" stroke-width="8" />
            <text id="Select Implementing Partner" fill="#E4882E" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="386" y="25.28">Select&#10;</tspan>
              <tspan x="386" y="57.28">Implementing&#10;</tspan>
              <tspan x="386" y="89.28">Partner</tspan>
            </text>
            <text id="2" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
          ...
          <g className="PCAT Offline" opacity={1}>
          ...
          <g className="HACT SharePoint" opacity={sharePoint && online ? 1 : 0.25}>
          ...
          <g className="LoA Offline" opacity={1}>
          ...
          <g className="ProjectDocument SharePoint Website" opacity={(sharePoint || website) && online ? 1 : 0.25}>
        ...
        <g id="AppraiseAndApprove" opacity={selectedHeader === 'AppraiseAndApprove' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head_3" style={{cursor:"pointer"}} onClick={() => {selectedHeader !== 'AppraiseAndApprove' ? setSelectedHeader('AppraiseAndApprove') : setSelectedHeader(null)}}>
            <circle id="Ellipse 4" cx="745" cy="136" r="31" fill="white" stroke="#E4882E" stroke-width="8" />
            <text id="Appraise &#38; Approve" fill="#E4882E" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="710" y="57.28">Appraise &#38;&#10;</tspan>
              <tspan x="710" y="89.28">Approve</tspan>
            </text>
            <text id="3" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
          ...
          <g className="LPAC Offline" opacity={1}>
          ...
          <g className="ProjIDOutputID Atlas" opacity={atlas && online ? 1 : 0.25}>
          ...
          <g className="IBT Atlas" opacity={atlas && online ? 1 : 0.25}>
          ...
          <g className="GM Atlas" opacity={atlas && online ? 1 : 0.25}>
          ...
          <g className="Link SharePoint" opacity={sharePoint && online ? 1 : 0.25}>
          ...
          <g className="OutputIDs SharePoint" opacity={sharePoint && online ? 1 : 0.25}>
        ...
        <g id="AnnualPlanning" opacity={selectedHeader === 'AnnualPlanning' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head_4" style={{cursor:"pointer"}}  onClick={() => {selectedHeader !== 'AnnualPlanning' ? setSelectedHeader('AnnualPlanning') : setSelectedHeader(null)}}>
            <circle id="Ellipse 5" cx="1181" cy="136" r="31" fill="white" stroke="#56ACC3" stroke-width="8" />
            <text id="Annual Planning" fill="#56ACC3" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="1146" y="57.28">Annual&#10;</tspan>
              <tspan x="1146" y="89.28">Planning</tspan>
            </text>
            <text id="4" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
          ...
          <g className="MinProjBoard Offline" opacity={1}>
          ...
          <g className="AWP Offline" opacity={1}>
          ...
          <g className="Prompt SharePoint" opacity={sharePoint && online ? 1 : 0.25}>
          ...
          <g className="HR Offline" opacity={1}>
        ...
        <g id="DeliverResults" opacity={selectedHeader === 'DeliverResults' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head_5" style={{cursor:"pointer"}}  onClick={() => {selectedHeader !== 'DeliverResults' ? setSelectedHeader('DeliverResults') : setSelectedHeader(null)}}>
            <circle id="Ellipse 6" cx="1505" cy="136" r="31" fill="white" stroke="#56ACC3" stroke-width="8" />
            <text id="Deliver Results" fill="#56ACC3" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="1470" y="57.28">Deliver&#10;</tspan>
              <tspan x="1470" y="89.28">Results</tspan>
            </text>
            <text id="5" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
          ...
          <g className="MMB Atlas" opacity={atlas && online ? 1 : 0.25}>
          ...
          <g className="BTORFV Offline" opacity={1}>
          ...
          <g className="MTFPE SharePoint" opacity={sharePoint && online ? 1 : 0.25}>
          ...
          <g className="PBRM Offline" opacity={1}>
          ...
          <g className="MYWP Atlas" opacity={atlas && online ? 1 : 0.25}>
        ...
        <g id="Monitor" opacity={selectedHeader === 'Monitor' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head_6" style={{cursor:"pointer"}}  onClick={() => {selectedHeader !== 'Monitor' ? setSelectedHeader('Monitor') : setSelectedHeader(null)}}>
            <circle id="Ellipse 7" cx="1829" cy="136" r="31" fill="white" stroke="#56ACC3" stroke-width="8" />
            <text id="Monitor_2" fill="#56ACC3" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="1794" y="89.28">Monitor</tspan>
            </text>
            <text id="6" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
          ...
          <g className="UREI Atlas" opacity={atlas && online ? 1 : 0.25}>
          ...
          <g className="PQAI SharePoint" opacity={sharePoint && online ? 1 : 0.25}>
          ...
          <g className="LLR Offline" opacity={1}>
          ...
          <g className="LLPR Offline" opacity={1}>
        ...
        <g id="Oversight" opacity={selectedHeader === 'Oversight' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head_7" style={{cursor:"pointer"}}  onClick={() => {selectedHeader !== 'Oversight' ? setSelectedHeader('Oversight') : setSelectedHeader(null)}}>
            <circle id="Ellipse 8" cx="2153" cy="136" r="31" fill="white" stroke="#56ACC3" stroke-width="8" />
            <text id="Oversight_2" fill="#56ACC3" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="2118" y="89.28">Oversight</tspan>
            </text>
            <text id="7" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="2144.28" y="145.28">7</tspan>
            </text>
          </g>
          <path id="Connetors_2" d="M2153 171V216C2153 221.523 2157.48 226 2163 226H2179" stroke="#56ACC3" />
          <g className="MPBRM Offline" opacity={1}>
        ...
        <g id="MakeChange" opacity={selectedHeader === 'MakeChange' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head_8" style={{cursor:"pointer"}}  onClick={() => {selectedHeader !== 'MakeChange' ? setSelectedHeader('MakeChange') : setSelectedHeader(null)}}>
            <circle id="Ellipse 9" cx="2477" cy="136" r="31" fill="white" stroke="#56ACC3" stroke-width="8" />
            <text id="Make Change" fill="#56ACC3" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="2442" y="57.28">Make&#10;</tspan>
              <tspan x="2442" y="89.28">Change</tspan>
            </text>
            <text id="8" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
          ...
          <g className="PD SharePoint Website" opacity={sharePoint && online ? 1 : 0.25}>
        ...
        <g id="Report" opacity={selectedHeader === 'Report' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head_9" style={{cursor:"pointer"}}  onClick={() => {selectedHeader !== 'Report' ? setSelectedHeader('Report') : setSelectedHeader(null)}}>
            <circle id="Ellipse 10" cx="2801" cy="136" r="31" fill="white" stroke="#56ACC3" stroke-width="8" />
            <text id="Report_2" fill="#56ACC3" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
              <tspan x="2766" y="89.28">Report</tspan>
            </text>
            <text id="9" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size="32" font-weight="bold" letter-spacing="0em">
          ...
          <g className="FACE Offline" opacity={1}>
          ...
          <g className="CDR Atlas" opacity={atlas && online ? 1 : 0.25}>
          ...
          <g className="DPPR Offline" opacity={1}>
          ...
          <g className="OREOI Atlas" opacity={atlas && online ? 1 : 0.25}>
        ...
        <g id="Close" opacity={selectedHeader === 'Close' || selectedHeader === null ? 1 : 0.25}>
          <g id="Head_10" style={{cursor:"pointer"}}  onClick={() => {selectedHeader !== 'Close' ? setSelectedHeader('Close') : setSelectedHeader(null)}}>
            <circle id="Ellipse 11" cx="35" cy="1824" r="31" fill="white" stroke="#BCBEC0" stroke-width="8" />
            <text id="10" fill="black" xmlSpace="preserve" style={{"whiteSpace": "pre"}} font-family="Proxima Nova" font-size